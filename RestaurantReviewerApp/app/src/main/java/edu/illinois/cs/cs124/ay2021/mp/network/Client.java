...
public final class Client {
  ...
  private RelatedRestaurants r;
  //helper methods
  public RelatedRestaurants getRelatedRestaurants() {
    r = new RelatedRestaurants(restaurantList, preferenceList);
    return r;
  }
  // initialize map
        ...
        new StringRequest(
            ...
            response -> {
              ...
              try {
                 ...
                 * correct type.
                 * response is a Json String containing the list of Restaurants
                 */
                ...
                for (int i = 0; i < restaurants.size(); i++) {
                  restaurantMap.put(restaurants.get(i).getId(), restaurants.get(i));
                }
